...
import { useDocuments, useDocumentStream, useUploadDocument } from "../../notebooks";
...
export function useFlashcardsNotebookSources(notebookId?: string): Result {
  ...
  const handleDeleteConfirm = async () => {
    ...
    setDeletingDocumentIds((previous) => new Set(previous).add(documentId));
